...
mon_init() {
    ...
    PREVIOUS_ASGS_PID=${ASGS_MON_PREVIOUS_PID-}
    PROCESS_STATE=${ASGS_MON_PROCESS_STATE-waiting}
    PROCESS_CANDIDATES=${ASGS_MON_PROCESS_CANDIDATES-}
    PROCESS_CHANGED=${ASGS_MON_PROCESS_CHANGED-0}
    ...
    export PREVIOUS_ASGS_PID PROCESS_STATE PROCESS_CANDIDATES PROCESS_CHANGED
